...
import { buildQuestionContext } from "@/utils/buildQuestionContext";
import {
  ArrowLeft,
  CheckCircle2,
  Circle,
...
export function QuestionsView({ selectedTopic, onBack, setCurrentQuestionContext, }) {
          ...
          <div className="flex flex-wrap gap-4">
            {difficulties.map((diff) => (
              <div key={diff} className="relative">
                <div
                  aria-hidden="true"
                  className={`absolute inset-0 translate-x-2 translate-y-2 ${difficultyFilter === diff
                ...
                <button
                  ...
                  className={`relative border-4 border-black px-6 py-2 font-extrabold shadow-[5px_5px_0_0_rgba(0,0,0,1)] transition-all duration-200 ${difficultyFilter === diff
              ...
              >
                ...
                <div className="flex items-start justify-between gap-6">
                  <div className="flex-1">
                    <h3
                      className={`text-2xl font-extrabold leading-snug ${completedMap[question.id]
          ...
          shadow-[3px_3px_0_0_#2C1810]`}
                ...
                <div className="flex justify-between items-center">
                  <button
                    ...
                    className={`flex items-center gap-3 font-extrabold text-[#2C1810] dark:text-[#F5E6D3] ${toggle.isPending ? "opacity-60 cursor-not-allowed" : ""
                      }`}
                  >
