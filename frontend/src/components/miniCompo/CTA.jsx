      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-[#C1502E] border-4 border-black p-16 shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] text-center relative overflow-hidden">
          <div className="relative z-10">
            ...
            <button className="px-16 py-6 bg-[#F5E6D3] text-[#2C1810] text-2xl font-black border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-2 hover:translate-y-2 transition-all inline-flex items-center gap-4">
              JOIN CALL OF CODE
